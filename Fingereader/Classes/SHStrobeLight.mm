...
//  Scapes
//
//  Created by Ali Mahouk on 8/10/13.
//
//
...
- (id)init
{
    ...
    if ( self )
    {
        ...
        self.frame = CGRectMake(0, -9, screenBounds.size.width, 20);
        
        _position = SHStrobeLightPositionFullScreen;
...
- (void)setStrobeLightPosition:(SHStrobeLightPosition)position
{
    ...
    switch ( position )
    {
        ...
        {
            self.frame = CGRectMake(0, 11, self.frame.size.width, self.frame.size.height);
            break;
        }
            
        case SHStrobeLightPositionNavigationBar:
        {
            self.frame = CGRectMake(0, 54, self.frame.size.width, self.frame.size.height);
            break;
        }
